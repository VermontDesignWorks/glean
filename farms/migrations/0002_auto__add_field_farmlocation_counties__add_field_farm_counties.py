...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FarmLocation.counties'
        db.add_column(u'farms_farmlocation', 'counties',
        ...
        # Adding field 'Farm.counties'
        db.add_column(u'farms_farm', 'counties',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['counties.County'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'FarmLocation.counties'
        db.delete_column(u'farms_farmlocation', 'counties_id')
        ...
        # Deleting field 'Farm.counties'
        db.delete_column(u'farms_farm', 'counties_id')
