...
from constants import ACCESS_LEVELS, VERMONT_COUNTIES, AGE_RANGES, PHONE_TYPE
...
class Profile(models.Model):
	...
	counties = models.ManyToManyField("Counties You'd like to Glean In", County, blank=True, null=True)
	...
	preferred_method = models.CharField(choices=PREFERRED_METHOD, max_length=1, default='1')
