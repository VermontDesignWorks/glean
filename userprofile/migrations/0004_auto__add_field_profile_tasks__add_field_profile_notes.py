...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.notes'
        db.add_column(u'userprofile_profile', 'notes',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Profile.notes'
        db.delete_column(u'userprofile_profile', 'notes')
    ...
    models = {
        ...
        u'userprofile.profile': {
            ...
            'state': ('django.db.models.fields.CharField', [], {'default': "'VT'", 'max_length': '2'}),
            'tasks': ('django.db.models.fields.CharField', [], {'default': "'gleaning'", 'max_length': '15', 'null': 'True'}),
