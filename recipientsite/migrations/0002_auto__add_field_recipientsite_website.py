...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RecipientSite.website'
        db.add_column(u'recipientsite_recipientsite', 'website',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RecipientSite.website'
        db.delete_column(u'recipientsite_recipientsite', 'website')
