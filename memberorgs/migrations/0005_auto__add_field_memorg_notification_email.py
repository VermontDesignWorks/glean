...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MemOrg.notification_email'
        db.add_column(u'memberorgs_memorg', 'notification_email',
                      self.gf('django.db.models.fields.CharField')(max_length='200', null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MemOrg.notification_email'
        db.delete_column(u'memberorgs_memorg', 'notification_email')
