...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MemOrg.testing'
        db.add_column(u'memberorgs_memorg', 'testing',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'MemOrg.testing_email'
        db.add_column(u'memberorgs_memorg', 'testing_email',
                      self.gf('django.db.models.fields.CharField')(default='', max_length='200', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MemOrg.testing'
        db.delete_column(u'memberorgs_memorg', 'testing')

        # Deleting field 'MemOrg.testing_email'
        db.delete_column(u'memberorgs_memorg', 'testing_email')
