...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MemOrg.testing_email'
        db.alter_column(u'memberorgs_memorg', 'testing_email', self.gf('django.db.models.fields.CharField')(max_length='200', null=True))

    def backwards(self, orm):

        # Changing field 'MemOrg.testing_email'
        db.alter_column(u'memberorgs_memorg', 'testing_email', self.gf('django.db.models.fields.CharField')(default='', max_length='200'))
