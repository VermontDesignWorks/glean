...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GleanEvent.volunteers_needed'
        db.alter_column(u'gleanevent_gleanevent', 'volunteers_needed', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'GleanEvent.volunteers_needed'
        db.alter_column(u'gleanevent_gleanevent', 'volunteers_needed', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'gleanevent.gleanevent': {
            ...
            'volunteers_needed': ('django.db.models.fields.IntegerField', [], {'default': '1', 'null': 'True', 'blank': 'True'}),
