...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PostGlean.timestamp'
        db.add_column(u'gleanevent_postglean', 'timestamp',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2011, 7, 7, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PostGlean.timestamp'
        db.delete_column(u'gleanevent_postglean', 'timestamp')
    ...
    models = {
        ...
        u'gleanevent.postglean': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'hours'", 'null': 'True', 'to': u"orm['auth.User']"})
        },
        u'memberorgs.memorg': {
