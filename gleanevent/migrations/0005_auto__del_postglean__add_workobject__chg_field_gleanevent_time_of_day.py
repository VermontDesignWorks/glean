...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'WorkObject'
        db.create_table(u'gleanevent_workobject', (
            ...
            ('hours', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
            ...
            ('task', self.gf('django.db.models.fields.CharField')(max_length=40)),
            ('notes', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
        ))
        db.send_create_signal(u'gleanevent', ['WorkObject'])


        # Changing field 'GleanEvent.time_of_day'
        db.alter_column(u'gleanevent_gleanevent', 'time_of_day', self.gf('django.db.models.fields.CharField')(max_length=2, null=True))
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'gleanevent_postglean', (
            ...
            ('last_name', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='hours', null=True, to=orm['auth.User'])),
            ('members', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('first_name', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('group', self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True)),
            ('notes', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('glean', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gleanevent.GleanEvent'], null=True)),
        ))
        db.send_create_signal(u'gleanevent', ['PostGlean'])

        # Deleting model 'WorkObject'
        db.delete_table(u'gleanevent_workobject')


        # Changing field 'GleanEvent.time_of_day'
        db.alter_column(u'gleanevent_gleanevent', 'time_of_day', self.gf('django.db.models.fields.CharField')(max_length=2))
    ...
    models = {
        ...
        u'gleanevent.workobject': {
            'Meta': {'ordering': "['-timestamp']", 'object_name': 'WorkObject'},
            ...
            'hours': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'task': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
