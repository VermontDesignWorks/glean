...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WorkEvent.member_organization'
        db.add_column(u'distro_workevent', 'member_organization',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='hours', to=orm['memberorgs.MemOrg']),
                      keep_default=False)


        # Changing field 'WorkEvent.first_name'
        db.alter_column(u'distro_workevent', 'first_name', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'WorkEvent.last_name'
        db.alter_column(u'distro_workevent', 'last_name', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'WorkEvent.group'
        db.alter_column(u'distro_workevent', 'group', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'WorkEvent.notes'
        db.alter_column(u'distro_workevent', 'notes', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'WorkEvent.task'
        db.alter_column(u'distro_workevent', 'task', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'WorkEvent.miles'
        db.alter_column(u'distro_workevent', 'miles', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'WorkEvent.members'
        db.alter_column(u'distro_workevent', 'members', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'WorkEvent.time'
        db.alter_column(u'distro_workevent', 'time', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'WorkEvent.date'
        db.alter_column(u'distro_workevent', 'date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):
        # Deleting field 'WorkEvent.member_organization'
        db.delete_column(u'distro_workevent', 'member_organization_id')


        # Changing field 'WorkEvent.first_name'
        db.alter_column(u'distro_workevent', 'first_name', self.gf('django.db.models.fields.CharField')(default='', max_length=25))

        # Changing field 'WorkEvent.last_name'
        db.alter_column(u'distro_workevent', 'last_name', self.gf('django.db.models.fields.CharField')(default='', max_length=25))

        # Changing field 'WorkEvent.group'
        db.alter_column(u'distro_workevent', 'group', self.gf('django.db.models.fields.CharField')(default='', max_length=25))

        # Changing field 'WorkEvent.notes'
        db.alter_column(u'distro_workevent', 'notes', self.gf('django.db.models.fields.CharField')(default='', max_length=50))

        # Changing field 'WorkEvent.task'
        db.alter_column(u'distro_workevent', 'task', self.gf('django.db.models.fields.CharField')(default='', max_length=50))

        # Changing field 'WorkEvent.miles'
        db.alter_column(u'distro_workevent', 'miles', self.gf('django.db.models.fields.CharField')(default='', max_length=10))

        # Changing field 'WorkEvent.members'
        db.alter_column(u'distro_workevent', 'members', self.gf('django.db.models.fields.CharField')(default='', max_length=10))

        # Changing field 'WorkEvent.time'
        db.alter_column(u'distro_workevent', 'time', self.gf('django.db.models.fields.CharField')(default='', max_length=10))

        # Changing field 'WorkEvent.date'
        db.alter_column(u'distro_workevent', 'date', self.gf('django.db.models.fields.DateField')(default=''))
    ...
    models = {
        ...
        u'distro.distro': {
            ...
            'containers': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'crops': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'date': ('django.db.models.fields.DateField', [], {}),
            'date_d': ('django.db.models.fields.DateField', [], {}),
            'del_or_pick': ('django.db.models.fields.CharField', [], {'default': "'d'", 'max_length': '2'}),
            'farm': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['farms.Farm']", 'null': 'True', 'blank': 'True'}),
            'field_or_farm': ('django.db.models.fields.CharField', [], {'default': "'g'", 'max_length': '1'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'distro.workevent': {
            ...
            'group': ('django.db.models.fields.CharField', [], {'max_length': '25', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_name': ('django.db.models.fields.CharField', [], {'max_length': '25', 'null': 'True', 'blank': 'True'}),
            'member_organization': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'hours'", 'to': u"orm['memberorgs.MemOrg']"}),
            'members': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            'miles': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            'notes': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'task': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
