...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Distro'
        db.create_table(u'distro_distro', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('member_organization', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['memberorgs.MemOrg'])),
            ('date_d', self.gf('django.db.models.fields.DateField')()),
            ('recipient', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['recipientsite.RecipientSite'])),
            ('field_or_farm', self.gf('django.db.models.fields.CharField')(default='g', max_length=1)),
            ('del_or_pick', self.gf('django.db.models.fields.CharField')(default='d', max_length=2)),
            ('date', self.gf('django.db.models.fields.DateField')()),
            ('crops', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('farm', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['farms.Farm'], null=True, blank=True)),
            ('pounds', self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True)),
            ('other', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('containers', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
        ))
        db.send_create_signal(u'distro', ['Distro'])


    def backwards(self, orm):
        # Deleting model 'Distro'
        db.delete_table(u'distro_distro')
