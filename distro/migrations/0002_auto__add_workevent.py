...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WorkEvent'
        db.create_table(u'distro_workevent', (
            ...
            ('group', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('members', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('task', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('miles', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('notes', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal(u'distro', ['WorkEvent'])


    def backwards(self, orm):
        # Deleting model 'WorkEvent'
        db.delete_table(u'distro_workevent')
    ...
    models = {
        ...
        u'distro.workevent': {
            ...
            'group': ('django.db.models.fields.CharField', [], {'max_length': '25'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_name': ('django.db.models.fields.CharField', [], {'max_length': '25'}),
            'members': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
            'miles': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
