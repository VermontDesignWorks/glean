...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Template', fields ['member_organization', 'default']
        db.create_unique(u'announce_template', ['member_organization_id', 'default'])


    def backwards(self, orm):
        # Removing unique constraint on 'Template', fields ['member_organization', 'default']
        db.delete_unique(u'announce_template', ['member_organization_id', 'default'])
    ...
    models = {
        ...
        u'announce.template': {
            'Meta': {'unique_together': "(('member_organization', 'default'),)", 'object_name': 'Template'},
