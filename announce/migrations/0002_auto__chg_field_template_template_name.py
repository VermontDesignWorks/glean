...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Template.template_name'
        db.alter_column(u'announce_template', 'template_name', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'Template.template_name'
        db.alter_column(u'announce_template', 'template_name', self.gf('django.db.models.fields.CharField')(max_length=40))
